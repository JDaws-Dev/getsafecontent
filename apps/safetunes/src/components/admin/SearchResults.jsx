...
function TopResultCard({ item, onTap }) {
  ...
  return (
    <div className="mb-6">
      ...
      <button
        onClick={() => onTap(item)}
        className="w-full group relative overflow-hidden rounded-2xl bg-accent-50 border border-gray-200 hover:border-accent-300 transition-all hover:shadow-lg"
      >
        <div className="p-5 flex items-center gap-5">
          ...
          <div className="flex-1 min-w-0 text-left">
            <h4 className="text-xl font-bold text-brand-navy truncate group-hover:text-accent-700 transition">
  ...
  return (
    <div className="flex items-center gap-3 py-3 group">
            ...
            <div className={`w-7 h-7 rounded-full bg-white/90 flex items-center justify-center shadow transition ${
              ...
              {isPlaying ? (
                <span className="w-3 h-3 flex gap-0.5">
                  <span className="w-1 h-3 bg-accent-600 rounded-sm" />
                  <span className="w-1 h-3 bg-accent-600 rounded-sm" />
                </span>
              ) : (
                <Play className="w-4 h-4 text-accent-600 ml-0.5" />
              )}
            </div>
          </div>
        </button>
      ...
      <button
        ...
        className="w-9 h-9 rounded-full bg-gray-100 hover:bg-accent-100 flex items-center justify-center transition flex-shrink-0 group-hover:bg-accent-50"
        title="Add song"
      >
        <Plus className="w-5 h-5 text-gray-500 group-hover:text-accent-600" />
      </button>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      {artworkUrl ? (
        ...
        <div className="w-32 h-32 rounded-2xl bg-accent-200 flex items-center justify-center shadow-md">
          <Disc className="w-12 h-12 text-accent-500" />
        </div>
      )}

      {/* Title - truncated */}
      <h5 className="mt-2 font-semibold text-brand-navy text-sm truncate group-hover:text-accent-700 transition">
  ...
  return (
    ...
    >
      ...
      {artworkUrl ? (
        ...
        <div className="w-32 h-32 rounded-full bg-accent-200 flex items-center justify-center shadow-md mx-auto">
  ...
  return (
    <div className="mt-6">
      ...
      <div className="mb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <h4 className="text-base font-semibold font-display text-brand-navy">
          Results
        ...
        <button
          onClick={onClear}
          className="text-sm text-accent-600 hover:text-accent-700 font-medium self-end sm:self-auto"
        >
          Clear
        </button>
      </div>
