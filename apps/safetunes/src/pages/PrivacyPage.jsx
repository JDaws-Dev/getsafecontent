        ...
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                To exercise these rights, contact us at <a href="mailto:jeremiah@getsafefamily.com" className="text-accent-600 hover:text-accent-700 font-medium">jeremiah@getsafefamily.com</a>
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                To exercise any of these rights, contact us at <a href="mailto:jeremiah@getsafefamily.com" className="text-accent-600 hover:text-accent-700 font-medium">jeremiah@getsafefamily.com</a>. We will respond to your request within 30 days.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                To exercise your California privacy rights, send a verifiable consumer request to <a href="mailto:jeremiah@getsafefamily.com" className="text-accent-600 hover:text-accent-700 font-medium">jeremiah@getsafefamily.com</a> with "California Privacy Request" in the subject line. We will verify your identity and respond within 45 days. You may designate an authorized agent to make requests on your behalf.
              </p>
