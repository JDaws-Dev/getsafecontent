          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            {oauthOnly ? (
              ...
              <div className="text-center">
                ...
                <Link
                  to="/login"
                  className="block w-full bg-accent-600 hover:bg-accent-700 text-white px-6 py-3 rounded-lg font-semibold transition text-center mb-3"
                >
                  Go to Login
                </Link>
              ...
              <div className="text-center">
                ...
                <button
                  ...
                  className="w-full bg-accent-600 hover:bg-accent-700 text-white px-6 py-3 rounded-lg font-semibold transition mb-3"
                >
                  Try Another Email
                </button>
