          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            {success ? (
              <div className="text-center">
                ...
                <Link
                  to="/admin"
                  className="inline-block bg-accent-600 hover:bg-accent-700 text-white px-6 py-2 rounded-lg font-semibold transition"
                >
                  Go to Dashboard
                </Link>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-center gap-2" onPaste={handlePaste}>
                      {code.map((digit, index) => (
                        <input
                          ...
                          className="w-12 h-14 text-center text-2xl font-bold border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-600 focus:border-transparent"
                          autoFocus={index === 0}
                        />
                      ))}
                    </div>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-accent-600 hover:bg-accent-700 text-white py-3 rounded-lg font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed"
                  >
