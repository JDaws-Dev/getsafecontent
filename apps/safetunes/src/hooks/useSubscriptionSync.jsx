 ...
 * in SafeTunes, so a subscription change made centrally (a comp, a Stripe
 * update) never reached this app's users table and the customer stayed locked
 * out while central insisted they had access.
 *
 * Must be rendered inside AuthProvider. Safe to mount above the router: the
 * hook no-ops unless there's an authenticated user with an email, so kid
 * sessions don't trigger it.
 */
