 ...
 * (family code → user → kid matched by name). Returns the profile in the same
 * shape getKidProfilesByFamilyCode ships (pin stripped, hasPin flag) so the
 * client can store it as the kid session with no further round-trip.
 */
