...
/**
 * Kid-side entry point for Bella's supervised AI-training flow:
 *   1. Enter 6-char family code
 *   2. See the family's profile picker (siblings)
 *   3. Tap your tile → enter PIN if set → land in chat
 *
 * No Clerk auth. Session token stashed in localStorage; chat reads it
 * to know which kid this is.
 */
