      ...
      <div className="px-6 py-2">
        <div className="max-w-md mx-auto">
          <div className="flex gap-2">
            <div className={`h-1 flex-1 rounded-full ${step >= 1 ? 'bg-accent-500' : 'bg-gray-200'}`} />
            <div className={`h-1 flex-1 rounded-full ${step >= 2 ? 'bg-accent-500' : 'bg-gray-200'}`} />
          </div>
        </div>
      </div>
      ...
      <main className="px-6 py-8 max-w-lg mx-auto">
        ...
        {step === 1 && (
          <div className="text-center space-y-6">
            <div className="w-20 h-20 bg-accent-500 rounded-2xl flex items-center justify-center mx-auto shadow-lg">
            ...
            <button
              onClick={() => setStep(2)}
              className="w-full bg-accent-500 hover:bg-accent-600 text-white py-4 rounded-xl font-semibold text-lg transition shadow-md"
            >
              Let's Get Started
            </button>
          </div>
        ...
        {step === 2 && (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent"
                      />
              ...
              <button
                onClick={addKid}
                className="w-full py-3 border-2 border-dashed border-gray-200 rounded-xl text-gray-500 hover:border-accent-300 hover:text-accent-500 transition flex items-center justify-center gap-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-3 pt-4">
              <button
                ...
                className="w-full bg-accent-500 hover:bg-accent-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white py-4 rounded-xl font-semibold text-lg transition shadow-md"
              >
          ...
          <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl">
            <div className="text-center space-y-4">
              ...
              <div className="bg-accent-50 border-2 border-accent-200 rounded-xl p-4">
                <div className="text-4xl font-display font-bold text-accent-600 tracking-widest font-mono mb-3">
                  {user?.familyCode}
                </div>
                <button
                  onClick={copyFamilyCode}
                  className="px-4 py-2 bg-accent-500 hover:bg-accent-600 text-white rounded-lg font-medium transition text-sm"
                >
              ...
              <button
                ...
                className="w-full bg-accent-500 hover:bg-accent-600 text-white py-3 rounded-xl font-semibold transition shadow-md"
              >
