        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              Contact us at <a href="mailto:jeremiah@getsafefamily.com" className="text-accent-500 hover:text-accent-600">jeremiah@getsafefamily.com</a> to
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              <a href="mailto:jeremiah@getsafefamily.com" className="text-accent-500 hover:text-accent-600">
