/**
 * Central JWT Authentication Context for SafeTube
 *
...
export function AuthProvider({ children }) {
  ...
  const verifyAndRefresh = useCallback(async (storedToken) => {
    ...
    try {
      ...
      if (!data.user.entitledApps?.includes('safetube')) {
        console.log('[AuthContext] User not entitled to SafeTube');
