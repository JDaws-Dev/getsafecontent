      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f9fafb; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
            ...
            <p style="margin: 0 0 16px 0; font-size: 16px;">
              Your SafeTube free trial expires in <strong>2 days</strong>.
            </p>
            <p style="margin: 0 0 16px 0; font-size: 16px;">
              To keep your kids' approved YouTube channels, profiles, and parental controls active, subscribe for just <strong>$4.99/month</strong>.
            </p>
            <p style="margin: 0 0 16px 0; font-size: 14px; color: #6b7280;">
              All your approved channels, kid profiles, and settings will be preserved when you subscribe.
            </p>
          </div>
          <div style="text-align: center; margin-bottom: 24px;">
            <a href="https://getsafefamily.com/signup" style="display: inline-block; background: #dc2626; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">Subscribe Now</a>
          </div>
          <div style="text-align: center; padding-top: 24px; border-top: 1px solid #e5e7eb;">
      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f9fafb; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
            <h2 style="margin: 0 0 16px 0; color: #1f2937;">Hi ${args.name},</h2>
            <p style="margin: 0 0 16px 0; font-size: 16px;">
              Your SafeTube free trial has ended.
            </p>
            <p style="margin: 0 0 16px 0; font-size: 16px;">
              Don't worry — <strong>all your data is preserved</strong>. Your approved YouTube channels, kid profiles, and watch history are waiting for you.
            </p>
            <p style="margin: 0 0 16px 0; font-size: 16px;">
          ...
          <div style="text-align: center; margin-bottom: 24px;">
            <a href="https://getsafefamily.com/signup" style="display: inline-block; background: #dc2626; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">Subscribe & Restore Access</a>
          </div>
          <div style="text-align: center; padding-top: 24px; border-top: 1px solid #e5e7eb;">
            <p style="color: #6b7280; font-size: 14px; margin: 0;">Questions? Reply to this email.</p>
            <p style="color: #9ca3af; font-size: 12px; margin: 8px 0 0 0;">The SafeTube Team</p>
...
export const sendAdminTrialExpirationSummary = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    const emailContent = `
      <h1>SafeTube Trial Expiration Summary</h1>
      ...
      <hr style="margin: 24px 0; border: none; border-top: 1px solid #e5e7eb;" />
      <p style="color: #6b7280; font-size: 14px;">Automated daily trial check — SafeTube</p>
    `;
