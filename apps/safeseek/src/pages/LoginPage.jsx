...
export default function LoginPage() {
  ...
  useEffect(() => {
    const rememberedEmail = localStorage.getItem('safestudy_remembered_email');
    if (rememberedEmail) {
    ...
    try {
      ...
      if (!result.success) {
        if (result.code === 'NOT_ENTITLED') {
          setError('Your account does not include SafeStudy. Visit getsafefamily.com to upgrade your plan.');
          setLoading(false);
          return;
        }
      ...
      localStorage.setItem('safestudy_remembered_email', formData.email);
      navigate('/admin');
    } catch (err) {
