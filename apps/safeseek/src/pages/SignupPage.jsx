    ...
    <div className="min-h-screen bg-brand-cream flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <h1 className="font-display text-3xl font-bold text-brand-navy text-center mb-2">Start your free trial</h1>
          ...
          <div className="space-y-4 mb-6">
            <p className="text-sm text-gray-600 text-center leading-relaxed">
              SafeStudy is part of the Safe Family suite. Sign up at our central site to get started with all Safe Family apps.
            </p>
          </div>

          <a
            href="https://getsafefamily.com/signup?app=safestudy"
