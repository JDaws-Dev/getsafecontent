      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto p-4">
        {messages === undefined ? (
          ...
          <div className="flex h-full flex-col items-center justify-center gap-3 text-center">
            <Bot className="h-12 w-12 text-accent-300" />
            <div>
          ...
          <div className="space-y-4">
            ...
            {isSending && (
              <div className="flex gap-3">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-brand-cream-2 text-ink-600">
                  <Bot className="h-4 w-4" />
                </div>
                <div className="rounded-2xl bg-brand-cream-2 px-4 py-2.5">
