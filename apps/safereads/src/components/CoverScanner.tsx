          ...
          <div className="relative w-full rounded-t-2xl bg-white p-4 sm:mx-4 sm:max-w-md sm:rounded-xl sm:rounded-t-xl">
            ...
            {!starting && !error && (
              <button
                ...
                className="mt-3 w-full rounded-lg bg-accent-600 py-3 text-sm font-medium text-white transition-colors hover:bg-accent-700"
              >
                Take Photo
              </button>
            )}
            ...
            {!starting && !error && (
              <button
                onClick={handleClose}
                className="mt-2 w-full rounded-lg border border-brand-cream-2 py-3 text-sm font-medium text-ink-600 transition-colors hover:bg-brand-cream-2 sm:hidden"
              >
                Cancel
              </button>
            )}
