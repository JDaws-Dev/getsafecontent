  ...
  async sendVerificationRequest({
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f9fafb; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
            ...
            <p style="margin: 0 0 20px 0; font-size: 16px;">
              Use this code to reset your SafeReads password:
            </p>

            <div style="text-align: center; margin: 24px 0;">
              <div style="display: inline-block; background: #92400E; color: white; padding: 16px 32px; border-radius: 8px; font-size: 32px; font-weight: bold; letter-spacing: 4px;">
                ${token}
              </div>
            </div>
          ...
          <div style="text-align: center; padding-top: 24px; border-top: 1px solid #e5e7eb;">
            <p style="color: #6b7280; font-size: 14px; margin: 0 0 8px 0;">
              Questions? Contact us at <a href="mailto:jeremiah@getsafefamily.com" style="color: #92400E; text-decoration: none;">jeremiah@getsafefamily.com</a>
            </p>
    ...
    try {
      const result = await resend.emails.send({
        ...
        to: email,
        subject: `Your SafeReads Password Reset Code: ${token}`,
        html: emailContent,
      });
