import { Book, Music, PlaySquare, Search, Check } from "lucide-react";
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <h3 className="text-2xl sm:text-3xl font-bold mb-3">
            Why protect just one when they use all four?
          </h3>
          <p className="text-white/70 max-w-2xl mx-auto">
            Kids switch between YouTube, music, books, and search every day. Protecting only one leaves gaps in the others.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mb-8">
          ...
          <div className="flex items-center gap-2 bg-white/10 rounded-full px-4 py-2">
            ...
            <span className="text-sm font-medium">Homework: Search</span>
            <Check className="w-4 h-4 text-emerald-400" />
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
          <div className="text-center sm:text-left">
            <p className="text-2xl sm:text-3xl font-bold">
              <span className="text-white/50 line-through text-xl mr-2">$19.96</span>
              $9.99/month
            </p>
            <p className="text-emerald-400 font-medium text-sm">
              Save 50% — that&apos;s $120 back every year
            </p>
          </div>
          <a
            href="#pricing"
